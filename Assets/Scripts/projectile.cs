...
public class projectile : MonoBehaviour {
	...
	void Update () {
		...
		if (Input.GetKeyDown (KeyCode.UpArrow)) {
			...
			Vector3 offsetBulletRight = new Vector3 (transform.position.x, transform.position.y, transform.position.x);
			Vector3 offsetBulletLeft = new Vector3 (transform.position.x, transform.position.y, transform.position.x);
